package com.example.environment.config.testcontainer.container;
...
import com.example.environment.config.testcontainer.util.Setting;

import static com.example.environment.config.testcontainer.util.Setting.realmInitPath;
