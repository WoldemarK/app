...
import com.example.environment.config.testcontainer.container.Containers;
import com.example.environment.config.testcontainer.container.KeycloakTestContainer;
import com.example.environment.config.testcontainer.container.WireMockTestContainer;
import com.example.environment.config.testcontainer.data.DtoCreator;
import com.example.environment.config.testcontainer.service.IndividualApiTestService;
import com.example.environment.config.testcontainer.service.KeycloakApiTestService;
import com.example.individualsapi.IndividualsApiApplication;
import com.example.spec.support.TestSupportConfig;
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, classes = {IndividualsApiApplication.class, TestSupportConfig.class})
@ActiveProfiles("test")
